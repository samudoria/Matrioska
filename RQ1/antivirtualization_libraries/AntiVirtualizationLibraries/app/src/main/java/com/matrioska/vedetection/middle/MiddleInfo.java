...
public class MiddleInfo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_middle_info);

        List<String> res = new Middle().detect(getBaseContext());
