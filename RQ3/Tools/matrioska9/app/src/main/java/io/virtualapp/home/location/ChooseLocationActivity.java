...
public class ChooseLocationActivity extends VActivity implements TencentLocationListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mMap = mapView.getMap();
        mSearchAdapter = new ArrayAdapter<MapSearchResult>(this, android.R.layout.simple_list_item_1, new ArrayList<>());
        ...
        findViewById(R.id.img_loc).setOnClickListener((v) -> {
            startLocation();
        });
        ((CheckBox) findViewById(R.id.checkbox)).setOnCheckedChangeListener((v, b) -> {
            showInputWindow();
        });
...
//        mSearchView.setSubmitButtonEnabled(true);
    ...
    private void showInputWindow() {
        ...
        view1.findViewById(R.id.btn_cancel).setOnClickListener((v2) -> {
            dialog.dismiss();
        });
