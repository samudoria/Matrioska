...
class APIbackward:
    ...
    def IntentTraceback(self,file_intentfunc, file_codetxt):
...
#        print "file_codetxt"
#        print file_codetxt
        satlist,t = ch.IntentSubstitute(file_intentfunc)

        # satlist不为空
        if len(satlist) and t == "virtualapp":
                ...
                for i in func:
                    ...
                    if i.find(";") != -1:
                                ...
                                if direct == 0 and lines[k].find("      name          : '") != -1 and lines[
                                    ...
                                    for i in range(m, count):
                                        ...
                                        if ty == "Ljava/lang/String":
                                            ...
                                            print content
                                            print argcount
                                        elif ty.find("Ljava/lang/Object") != -1:
                                            h = g
                        ...
                        if final == 1:
                            return t
                            break
        elif t == "replugin" or t == "droidplugin":
            return t
        else:
            # satlist是空的
            return 'No VA Engine'
