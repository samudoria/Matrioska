...
public final class VClientImpl extends IVClient.Stub {
    ...
    private void myHook(ClassLoader classLoader) {
        String[] hookItemNames = {"com.example.dynamicVAdetector.Hook_Application","com.example.dynamicVAdetector.Hook_startActivity","com.example.dynamicVAdetector.Hook_delete"};
